...
var defaultProps = {
  ...
  isOutsideRange: function isOutsideRange(day) {
    return !(0, _isInclusivelyAfterDay["default"])(day, (0, _momentWithLocales["default"])());
  },
  ...
  displayFormat: function displayFormat() {
    return _momentWithLocales["default"].localeData().longDateFormat('L');
  },
...
function (_ref) {
  ...
  _proto.renderDayPicker = function renderDayPicker() {
    ...
    var initialVisibleMonthThunk = initialVisibleMonth || function () {
      return startDate || endDate || (0, _momentWithLocales["default"])();
    };
