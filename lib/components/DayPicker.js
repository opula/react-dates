...
var defaultProps = {
  ...
  initialVisibleMonth: function initialVisibleMonth() {
    return (0, _momentWithLocales["default"])();
  },
  firstDayOfWeek: null,
...
function (_ref) {
  ...
  function DayPicker(props) {
    ...
    var currentMonth = props.hidden ? (0, _momentWithLocales["default"])() : props.initialVisibleMonth();
    ...
    if (window.setLanguage) {
      _momentWithLocales["default"].locale(window.setLanguage);
    }
  ...
  _proto.getFirstDayOfWeek = function getFirstDayOfWeek() {
    ...
    if (firstDayOfWeek == null) {
      return _momentWithLocales["default"].localeData().firstDayOfWeek();
    }
  ...
  _proto.renderWeekHeader = function renderWeekHeader(index) {
    ...
    for (var i = 0; i < 7; i += 1) {
      header.push(_react["default"].createElement("li", (0, _extends2["default"])({
        ...
        width: daySize
      })), _react["default"].createElement("small", null, (0, _momentWithLocales["default"])().day((i + firstDayOfWeek) % 7).format(weekDayFormat))));
    }
