...
var defaultProps = {
  month: (0, _momentWithLocales["default"])(),
...
function (_ref) {
  ...
  function CalendarMonth(props) {
    ...
    _this.state = {
      weeks: (0, _getCalendarMonthWeeks["default"])(props.month, props.enableOutsideDays, props.firstDayOfWeek == null ? _momentWithLocales["default"].localeData().firstDayOfWeek() : props.firstDayOfWeek)
    };
  ...
  _proto.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    ...
    if (!month.isSame(prevMonth) || enableOutsideDays !== prevEnableOutsideDays || firstDayOfWeek !== prevFirstDayOfWeek) {
      this.setState({
        weeks: (0, _getCalendarMonthWeeks["default"])(month, enableOutsideDays, firstDayOfWeek == null ? _momentWithLocales["default"].localeData().firstDayOfWeek() : firstDayOfWeek)
      });
    }
  };
