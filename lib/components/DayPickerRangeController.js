...
function (_ref) {
  ...
  function DayPickerRangeController(props) {
    ...
    _this.today = (0, _momentWithLocales["default"])();
    _this.modifiers = {
  ...
  _proto.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    ...
    var today = (0, _momentWithLocales["default"])();
  ...
  _proto.doesNotMeetMinimumNights = function doesNotMeetMinimumNights(day) {
    ...
    return isOutsideRange((0, _momentWithLocales["default"])(day).subtract(minimumNights, 'days'));
  };
  ...
  _proto.isFirstDayOfWeek = function isFirstDayOfWeek(day) {
    ...
    return day.day() === (firstDayOfWeek || _momentWithLocales["default"].localeData().firstDayOfWeek());
  };

  _proto.isLastDayOfWeek = function isLastDayOfWeek(day) {
    var firstDayOfWeek = this.props.firstDayOfWeek;
    return day.day() === ((firstDayOfWeek || _momentWithLocales["default"].localeData().firstDayOfWeek()) + 6) % 7;
  };
