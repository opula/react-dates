...
function getCalendarMonthWeeks(month, enableOutsideDays) {
  var firstDayOfWeek = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : _momentWithLocales["default"].localeData().firstDayOfWeek();

  if (!_momentWithLocales["default"].isMoment(month) || !month.isValid()) {
